...
/******/ 	var hotCurrentHash = "e7023c855a596610a403"; // eslint-disable-line no-unused-vars
...
const app = () => '<div style="padding: 20px"><h1>Welcome to hello-api</h1></div>';
...
Object(__WEBPACK_IMPORTED_MODULE_0_http__["createServer"])((request, response) => response.end(Object(__WEBPACK_IMPORTED_MODULE_1__app__["default"])())).listen(port, () => process.stdout.write(`Running on :${port}\n`));

if (true) {
  module.hot.accept("./src/app.js", function() { /* harmony import */ __WEBPACK_IMPORTED_MODULE_1__app__ = __webpack_require__("./src/app.js");  });
}
